...
if($conn->query($sql) === TRUE){
  ...
  $conn->query("UPDATE  tbluser SET Stories = Stories + 1 WHERE user_id='$_SESSION[user_id]'");
  $Updatedraw = $conn->query("SELECT * FROM tbldrawuse WHERE user_id = '$_SESSION[user_id]'");
