...
<div class="feed-like" id="<?php echo $tblcontent['contentTop']; ?>" >
    <? echo $image ?>
    <div class="feed-title">

    <div class="feed-type-into">
    ...
    <div class="feed-tag" style="width: 50%;">
        <div class="feed-tag-into">
            <div class="feed-tag-text" onclick="feed_top_tag(<?php echo $tblcontent['tag_id']; ?>)"><?php echo $tblcontent['tagname']; ?></div>
        </div>
    </div>
