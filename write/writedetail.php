...
//function ส่งข้อมูลการเพิ่ม tag ไปยังฐานข้อมูล
function sendtag(){
 ...
 $(document).ready(function(){
    //ระบบการรีเซ็ต style,font,size ทั้งหมดที่ copy มาวาง
    ...
    //ระบบการค้นหาและเพิ่มหัวข้อของเนื้อหา
